...
- **结果分析与 release notes 已背书（2026-08）**：`results/v0.4.2/`（run-level/aggregated/subgroup CSV + result_handover.json + result_analysis.md）与 CHANGELOG v0.4.2 条目获 Reviewer 短复检通过（`ef1e536`）；309 tests 基线。
