...
- [ ] `ruff format --check .`
- [ ] `pytest -q`
- [ ] `python -m scripts.simulation.batch_run --config configs/v0.4.1/smoke_v4_1.json --dry-run`
- [ ] The complete pytest count matches the README release baseline (v0.4.2 pure branch: 459).
