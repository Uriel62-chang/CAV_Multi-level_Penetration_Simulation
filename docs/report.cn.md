...
- **s3 瓶颈语义**：基本图为瓶颈排队–吞吐关系（非主线基本图）；HV 吞吐 ~500
  veh/h/道量级；**IDM 全 CAV 瓶颈吞吐 ~3,200–3,900**（峰值 3,903 @k20，k30–55
  3,168–3,285），**高于 τ 上限的 2,400**；CACC 全 CAV 降至 **~1,500–2,600**
  （峰值 2,583 @k15，k30–55 仅 ~1,450–1,520）——**2→1 合流冲突主导**瓶颈行为。
