...
- **已验证**：167 tests passed；Ruff/mypy/format/compileall 通过；pilot 162 与 legacy 10,080 dry-run 通过；micro-pilot Level 1 通过（10/10）；Level 2 calibration completed（failed gate，48 runs with extratime=1.0+merge）。
