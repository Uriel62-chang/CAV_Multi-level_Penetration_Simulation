...
IDENTIFIER_COLUMNS = [
    "run_id", "scenario", "model", "pCAV", "vehN", "seed",
]
...
CAPACITY_COLUMNS = [
    "mean_flow_veh_h", "max_flow_veh_h", "mean_speed_m_s",
    "detector_mean_speed_temporal_variance", "detector_speed_window_count",
    "det_xml",
]
...
QUALITY_COLUMNS = [
    "data_quality", "data_quality_detail",
]
...
AUDIT_COLUMNS = [
    ...
    "ee_parse_success", "vr_parse_success",
]
